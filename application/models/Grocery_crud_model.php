...
class Grocery_crud_model  extends CI_Model  {
    ...
    function insert_data_dosen($nik,$nama_dosen,$id_spesialis,$id_matkul,$nama_matkul,$sks,$id_jurusan,$nama_jurusan,$id_prodi,$nama_prodi,$kelas,$ruangan,$waktu,$tanggal)
    {
        ...
        $data = array(
            ...
            'waktu'         => $waktu,
            'tanggal'       => $tanggal);
        $insert = $this->db->insert('data_dosen', $data);
        if ($insert)
        {
            return 1;
        }
    ...
    function show_dosen()
    {
        $hasil=$this->db->query("SELECT * FROM data_dosen");
        return $hasil;
    }
}
