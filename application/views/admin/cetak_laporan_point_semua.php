...
<table  border="0" width=100% style="font-family: Cambria; font-size: 9pt;">
    <tr>
				<td align="CENTER" colspan="15"><strong>LAPORAN POINT</strong></td>
    </tr>
		<tr>
				<td align="CENTER" colspan="15">'.$key->bulan.' '.$key->tahun.'	</td>
		</tr>
    <tr>
...
<table width="100%" border="1" >
	...
	$rcd .= '<tr style="font-family: Cambria; font-size: 8pt; ">
		...
		<td valign="top" align="left" >'.$key->nama.'</td>
		<td valign="top" align="left" >'.$key->poin.'</td>
...
if($param==1){
	...
	header("Content-Disposition: attachment; filename=Laporan Point $x.xls");
	echo $html;
}else{
